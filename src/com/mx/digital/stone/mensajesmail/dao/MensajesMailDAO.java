 ...
 */
package com.mx.digital.stone.mensajesmail.dao;
...
import com.mx.digital.stone.mensajesmail.utils.ConexionMySQL;
...
public class MensajesMailDAO {
     ...
     */
    protected static final Logger LOG = Logger.getLogger(MensajesMailDAO.class);

    /**
     * Campo OBTEN_MENSAJES_SIN_ENVIAR de tipo String.
     */
    private static final String OBTEN_MENSAJES_SIN_ENVIAR = "select * from mensajes_mail where enviado = 0";
    ...
    public final List<MensajesMailVO> getCorreosSinEnviar() throws Exception {
        ...
        try {
            ...
            throw new Exception("Error en getCorreosSinEnviar()");
        } finally {
            try {
                if (rs != null) {
                    rs.close();
